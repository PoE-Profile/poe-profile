...
new Vue({
    ...
    data: {
        ...
        classIds: [
            ...
            {id: 'Scavenger', name: 'Scion', oldId: 0, ascendancyClass:1},
            ...
            {id: 'Antiquarian', name: 'Marauder', oldId: 1, ascendancyClass:3},
            {id: 'Behemoth', name: 'Marauder', oldId: 1, ascendancyClass:2},
            {id: 'Ancestral Commander', name: 'Marauder', oldId: 1, ascendancyClass:1},
            // {id: 2, name: 'Ranger'},//old
            {id: 'Ranger', name: 'Ranger', oldId: 2, ascendancyClass:0},
            {id: 'Warden', name: 'Ranger', oldId: 2, ascendancyClass:1},
            ...
            {id: 'Whisperer', name: 'Ranger', oldId: 2, ascendancyClass:2},
            {id: 'Wildspeaker', name: 'Ranger', oldId: 2, ascendancyClass:1},
            // {id: 3, name: 'Witch'},//old
            ...
            {id: 'Harbinger', name: 'Witch', oldId: 3, ascendancyClass:1},
            {id: 'Herald', name: 'Witch', oldId: 3, ascendancyClass:2},
            {id: 'Bog Shaman', name: 'Witch', oldId: 3, ascendancyClass:3},
            ...
            {id: 'Gambler', name: 'Duelist', oldId: 4, ascendancyClass:2},
            {id: 'Paladin', name: 'Duelist', oldId: 4, ascendancyClass:3},
            {id: 'Aristocrat', name: 'Duelist', oldId: 4, ascendancyClass:1},
            ...
            {id: 'Architect of Chaos', name: 'Templar', oldId: 5, ascendancyClass:1},
            {id: 'Polytheist', name: 'Templar', oldId: 5, ascendancyClass:3},
            {id: 'Puppeteer', name: 'Templar', oldId: 5, ascendancyClass:2},
            ...
            {id: 'Surfcaster', name: 'Shadow', oldId: 6, ascendancyClass:3},
            {id: 'Servant of Arakaali', name: 'Shadow', oldId: 6, ascendancyClass:1},
            {id: 'Blind Prophet', name: 'Shadow', oldId: 6, ascendancyClass:2},
        ],
        loadingItems:false,
        showBandits:false,
        favStore: favStore,
